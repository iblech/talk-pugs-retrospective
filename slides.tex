...
\begin{frame}[label=further-highlights]\frametitle{Further highlights}
  \begin{Mdescription}{Tag 000}
    ...
    \hyperlink{user-defined-ops}{\beamerbutton{see code}}

    \item[Day 109] gather/take
    \hyperlink{gather-take}{\beamerbutton{see code}}

    \item[Day 111] Hyper operators
    \hyperlink{hyper-operators}{\beamerbutton{see code}}

    \item[Day 113] ``Pugs runs CPAN modules!''
    \hyperlink{pugs-cpan}{\beamerbutton{see code}}
  \end{Mdescription}

  \hyperlink{the-end}{\beamerbutton{skip details}}
\end{frame}
% XXX: Align hyperlinks

% Continue here: http://pugs.blogs.com/pugs/2005/05/page/1/.
