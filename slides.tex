...
\note{
  \begin{itemize}
    ...
    programmers new to both the Pugs codebase and Haskell.}{Shae Errison}{April 5st,
...
\note{
  \begin{itemize}
    ...
    and Loathing in Pugsland}}), \ldots
  \end{itemize}

  \vspace{-1em}
  \inputminted{haskell}{code-snippets/day1-main.hs}
}
