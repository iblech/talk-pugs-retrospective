...
\note{
  \begin{itemize}
    ...
    by juxtaposition, without parentheses -- i.\,e.\@ \texttt{f x y} instead of
    ...
    of the line or block -- i.\,e.\@ \texttt{foo \$ a long expression} instead
    ...
    values; this flexibility is necessary to support user-defined operators.
...
\note{
  ...
  which is the Common Lisp Object System. Objective~C's objects runtime,
