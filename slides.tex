...
\begin{frame}[label=further-highlights]\frametitle{Further highlights}
  \begin{Mdescription}{Tag 00}
    ...
    assignment \hyperlink{tied-env}{\beamerbutton{see code}}
    ...
    \hyperlink{shiny-monad}{\beamerbutton{see code}}

    \item[Day 99] ``Full named rules!''
    \hyperlink{rules}{\beamerbutton{see code}}
  \end{Mdescription}
\end{frame}

% Continue here: http://pugs.blogs.com/pugs/2005/05/page/2/.
...
\note{
  \justifying
  For school reasons, I withdrew from Pugs development before its active phase
  ended. Therefore I'm not qualified to report on the reasons for its end
  and deem it unresponsible to speculate in public.

  Note that Pugs is still kept compatible with respect to new GHC
  releases.\par
}
...
% those speculations only from variou online sources.

\section{Long-term results of Pugs}

\begin{frame}\frametitle{Long-term results of Pugs}
  \begin{itemize}
    \item Renewed interest in Perl 6.
    \item Major refinements of the specification.
    \pause
    \item \hil{The test suite.} More than~$10\,000$ unit tests.
    \pause
    \item The culture.
...
\section{Day 88: ``A shiny new monad.''}
...
\section{Day 99: ``Full named rules!''}
